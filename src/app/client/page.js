...
//       formData.append("projectEndDate", endDate);
//       formData.append("projectStatus", status.toLowerCase());
...
//     try {
//       const formData = new FormData();
//       formData.append("clientName", editClientData.clientName);
//       formData.append("projectName", editClientData.projectName);
//       formData.append("projectDescription", editClientData.description);
//       formData.append("projectStartDate", editClientData.startDate);
//       formData.append("projectEndDate", editClientData.endDate);
//       formData.append("projectStatus", editClientData.status.toLowerCase());
//       formData.append("clientEmail", editClientData.email);
//       formData.append("clientPhone", editClientData.phone);
...
//       description: client.projectDescription,
//       startDate: formatDateForInput(client.projectStartDate),
//       endDate: formatDateForInput(client.projectEndDate),
//       email: client.clientEmail,
//       phone: client.clientPhone,
//       avatar: client.avatar?.url || null,
//       avatarPreview: client.avatar?.url || '',
//       status: client.projectStatus.charAt(0).toUpperCase() + 
//              client.projectStatus.slice(1).toLowerCase(),
//     });
...
//                   placeholder="Project Name"
//                   className="border p-2 rounded w-full"
//                   value={editClientData.projectName}
//                   onChange={(e) =>
//                     setEditClientData({ ...editClientData, projectName: e.target.value })
//                   }
//                   required
//                 />
//                 <textarea
...
//                   onChange={(e) =>
//                     setEditClientData({ ...editClientData, description: e.target.value })
//                   }
//                   required
//                 />
//                 <input
...
//                   onChange={(e) =>
//                     setEditClientData({ ...editClientData, startDate: e.target.value })
//                   }
//                   required
//                 />
//                 <input
...
//                   onChange={(e) =>
//                     setEditClientData({ ...editClientData, endDate: e.target.value })
//                   }
//                   required
//                 />
//                 <input
...
//                 <strong>{deleteTarget.clientName}</strong>s profile?
//               </p>
...
//                     </Avatar>
//                   </td>
//                   <td className="p-3 border-b">{client.clientName}</td>
//                   <td className="p-3 border-b">{client.projectName}</td>
//                   <td className="p-3 border-b">
//                     {client.projectStartDate ? new Date(client.projectStartDate).toLocaleDateString() : 'N/A'}
//                   </td>
//                   <td className="p-3 border-b">
//                     {client.projectEndDate ? new Date(client.projectEndDate).toLocaleDateString() : 'N/A'}
//                   </td>
//                   <td className="p-3 border-b">
//                     <span
